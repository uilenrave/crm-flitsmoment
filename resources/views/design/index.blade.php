...
<div style="margin-bottom:1rem;">
    ...
    <span style="font-size:.75rem;color:#64748b;">AI-achtergrond genereren (Gemini)</span>
</div>
...
<div class="dg-card" style="padding:1rem 1.25rem;margin-bottom:1.25rem;display:flex;flex-direction:column;gap:.6rem;">
    <label style="font-size:.8rem;font-weight:700;color:#334155;">Ontwerpen voor een boeking?</label>
    <select id="dg-booking-picker" style="padding:.5rem .7rem;border:1px solid #e2e8f0;border-radius:.5rem;font-size:.85rem;">
    ...
    <button type="button" class="dg-btn-primary" style="width:100%;" onclick="const v=document.getElementById('dg-booking-picker').value; if(v) window.location=v;">Ga naar ontwerp →</button>
</div>
@endsection
...
@push('scripts')
@include('design._tool_scripts', compact('dgMode', 'urls', 'eventTypes', 'eventType', 'promptLabel', 'promptKey', 'promptDefault', 'promptsByType', 'logoEventTypes', 'masks', 'results', 'input', 'googleFonts'))
@endpush
@endsection
